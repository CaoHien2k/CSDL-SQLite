...
public class MyDatabase extends SQLiteOpenHelper {
    ...
    private static final String COL_2 = "Ten";
    ...
    public boolean insertData(String ten, String toan, String li, String hoa) {
    ...
    public boolean updateData(String id, String ten, String toan, String li, String hoa) {
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues values = new ContentValues();
        values.put(COL_1, id);
        values.put(COL_2, ten);
